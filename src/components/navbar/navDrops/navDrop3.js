...
export default function Navdrop3() {
    return (
        <Flex padding="10px 0" justify="space-evenly" zIndex="10" display="none" id="navHo3" bg="white" right="2px" top="41px" position="absolute" w="800px" minH="200px">
            <Flex flexDirection="column" gap="5pxFlex">
